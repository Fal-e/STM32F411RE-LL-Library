...
This project started as an older STM32F411RE bare-metal library and examples repo. It is being revived as a small public low-level peripheral library with clearer documentation, reproducible build/import steps, maintained examples, and careful review of hardware-facing code.
...
Detailed import notes are in [docs/BUILDING.md](docs/BUILDING.md). CI notes are in [docs/CI.md](docs/CI.md). A reproducible command-line build system is planned but is not yet present.
