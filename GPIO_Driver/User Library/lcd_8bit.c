...
// 			***** IMPORTANT *****
// If using 8-bit mode. you must comment out the 4-bit code otherwise there will be multiple definitions.
// Future work: Include both in one .c and .h file and select one to initialize via a function.
/*
