...
Each change should be tied to one GitHub issue and kept small enough to review comfortably. After Codex review finds no changes requested and required checks or verification notes are complete, the PR may be merged without waiting for manual maintainer review unless the maintainer explicitly asks to review first.
...
Do not claim hardware testing, build success, production use, users, downloads, or adoption unless it was actually verified.
